## This is the prototype mission form. It contains UI elements that I'd like to make use of in the new form.
## Once the new form is complete, this form will be removed.
...
# We don't want to automated URL loader to load these URLs, there just here as reference for how the UI components
# can be used.
bad_urlpatterns = [
