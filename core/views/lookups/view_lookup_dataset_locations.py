...
# Todo: This lookup is really a Configuration table. I'm using a lookup view for now, but it should be represented
#       differently in the future and have strict superuser restrictions on it.
...
lookup_model = models.DatasetLocations
...
app_name = 'core'
lookup_title = _('Dataset Locations')
name_key = 'dataset_locations'
