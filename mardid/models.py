...
class MissionMetadata(models.Model):
    ...
    contact_group = models.ForeignKey(GroupRole, related_name='mission_metadata', on_delete=models.CASCADE, db_column='CONTACT_GROUP_SEQ')
    program = models.ForeignKey(Program, related_name='mission_metadata', on_delete=models.CASCADE, db_column='PROGRAM_SEQ')
    institute = models.ForeignKey(Institute, related_name='mission_metadata', on_delete=models.CASCADE, db_column='INSTITCH_SEQ')
...
class Equipment(models.Model):
    ...
    entered_by = models.ForeignKey(Contact, related_name='equipment', on_delete=models.CASCADE, db_column='ENTERED_BY_ID')
...
class DataCollected(models.Model):
    ...
    date_entered = models.DateField(db_column='DATE_ENTERED')
    entered_by = models.CharField(max_length=100, db_column='ENTERED_BY')
